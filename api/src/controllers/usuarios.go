...
func BuscarUsuario(w http.ResponseWriter, r *http.Request) {
	...
	//Pega o ID enviado pela rota e converte para INT64
...
func AtualizarUsuario(w http.ResponseWriter, r *http.Request) {
	...
	if erro != nil {
		respostas.Erro(w, http.StatusUnauthorized, errors.New("Não é possivel alterar um usuario que não seja o seu"))
		return
	}
...
func DeletarUsuario(w http.ResponseWriter, r *http.Request) {
	...
	if usuarioID != usuarioIDNoToken {
		respostas.Erro(w, http.StatusForbidden, errors.New("Não é possivel apagar um usuario que não seja o seu"))
		return
	}
...
func AtualizarSenha(w http.ResponseWriter, r *http.Request) {
	...
	if usuarioIDNotoken != usuarioID {
		respostas.Erro(w, http.StatusForbidden, errors.New("Não é possivel alterar a senha desse usuario"))
		return
	}
	...
	if erro = seguranca.VerificarSenha(senhaSalvaNoBanco, senha.Atual); erro != nil {
		respostas.Erro(w, http.StatusUnauthorized, errors.New("Senha atual diferente da senha nova"))
		return
	}
